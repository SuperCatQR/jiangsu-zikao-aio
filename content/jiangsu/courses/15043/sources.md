...
| [《15043 中国近现代史纲要》课程考试大纲.pdf](https://www.jseea.cn/webfile/upload/2025/02-25/14-25-1908861288944883.pdf) | 《15043 中国近现代史纲要》课程考试大纲.pdf | 路径日期 2025-02-25；前言署「2024 年 8 月」（照录）；适用考期 `未声明` | match | 2026-08-24 | 官方考纲 PDF 出处；`大纲目录` 十章章名（不转载正文） | verified-metadata |
...
- HTML 页不含章节目录（HTML 章目仍为缺口）。章名已由官方 PDF `大纲目录` 支撑（本地切片 `sources/jiangsu/processed/syllabus/15043-modern-chinese-history-gaogang-2024/document.extracted.md`），见 `syllabus.md`；不得粘贴 PDF 或抽取稿正文。
- 最后机器核验日期：2026-08-24。
