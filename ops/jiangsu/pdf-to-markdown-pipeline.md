...
```text
sources/jiangsu/major-plans-2024/<序号>.<专业名称>专业（层次）考试计划.pdf
```

输出：

```text
content/jiangsu/majors/<major>/sources/plan.raw.xml
content/jiangsu/majors/<major>/sources/plan.raw.txt
```
...
pdftohtml -xml -i -noframes \
  "<source-pdf>" \
  "content/jiangsu/majors/<major>/sources/plan.raw"
...
- `sources/jiangsu/major-plans-2024/*.pdf`
- `sources/jiangsu/*.pdf`
- `sources/jiangsu/textbooks/*.pdf`
- `sources/jiangsu/syllabus/*.pdf`
- `sources/jiangsu/past-papers/**/*.pdf`
