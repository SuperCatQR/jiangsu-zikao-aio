...
- 必要时新增课程页：`content/jiangsu/courses/<课程代码>/index.md`
...
```bash
mkdir -p content/jiangsu/majors/080901-computer-science-and-technology/sources
...
4. 公共课程页已存在时链接到 `../../courses/<课程代码>/index.md`；不存在时写“待建”。
5. `建设优先级`建议：
...
复制 `ops/jiangsu/templates/major.md`，填充字段后保存到：

```text
content/jiangsu/majors/<专业代码>-<english-slug>/index.md
```

命名示例：

```text
content/jiangsu/majors/080901-computer-science-and-technology/index.md
```
...
source_file: "sources/jiangsu/textbooks/jiangsu-2025-10-2026-01-schedule-textbooks.xml"
status: "checked"
notes: "不托管教材电子版"
```
...
- [计算机科学与技术（专升本）](../../content/jiangsu/majors/080901-computer-science-and-technology/)
- Raw XML 来源：`content/jiangsu/majors/080901-computer-science-and-technology/sources/plan.raw.xml`
