...
```text
sources/jiangsu/past-papers/<course-code>/<year>-<period>-<source-slug>.pdf
```

示例：

```text
sources/jiangsu/past-papers/02333/2025-04-official.pdf
```
...
3. 下载后运行 `scripts/process-pdfs.ps1 -Force`，处理产物会进入 `sources/jiangsu/processed/past-papers/<course-code>/`。
