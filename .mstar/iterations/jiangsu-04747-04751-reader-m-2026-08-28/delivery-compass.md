...
|---------|------|--------|-------|
| `04747-official-syllabus-reader-path` | 04747 Java official-syllabus chapter index and reader path | InProgress | P1/M; user authorized the fifth stale baseline assertion; targeted fix round 2 pending delegated execution |
